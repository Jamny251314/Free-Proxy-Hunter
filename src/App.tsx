...
function App() {
  return (
    <Routes>
      ...
      <Route path="/proxies" element={<AppContent />} />
...
function AppContent() {
  ...
  const isProxyPage = location.pathname === '/proxies';
  ...
  // 代理池：在顶层持有唯一一份状态与 SSE 连接，侧边栏与代理池页面共用
  ...
  useEffect(() => {
    ...
    } else if (!urlSessionId && !isSettingsPage && !isProxyPage && currentSessionId) {
      setCurrentSessionId(null);
    }
  }, [urlSessionId, isSettingsPage, isProxyPage, currentSessionId, setCurrentSessionId]);
  ...
  return (
    ...
    >
      ...
      <Sidebar
        ...
        isProxyPage={isProxyPage}
        sidebarOpen={sidebarOpen}
        agents={agents}
        getAgent={getAgent}
        proxyAlive={proxyPool.stats.alive}
